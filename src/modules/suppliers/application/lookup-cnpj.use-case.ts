      ...
      return {
        ...
        outcome: {
          ...
          data: {
            ...
            fiscal: {
              openedOn: existingSupplier.openedOn,
              legalNature: existingSupplier.legalNature,
              companySize: existingSupplier.companySize,
              shareCapitalCents: existingSupplier.shareCapitalCents,
              mainActivityCode: existingSupplier.mainActivityCode,
              mainActivityDescription: existingSupplier.mainActivityDescription,
              simplesOpted: existingSupplier.simplesOpted,
              meiOpted: existingSupplier.meiOpted,
              taxRegime: existingSupplier.taxRegime,
              partners: existingSupplier.partners,
            },
            stateRegistration: existingSupplier.stateRegistration,
          },
        },
      };
    }
