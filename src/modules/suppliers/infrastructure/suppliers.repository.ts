  ...
  async create(
    ...
    const raw = await prismaClient(this.prisma, context).supplier.create({
      data: {
        ...
        share_capital_cents: data.shareCapitalCents ?? null,
        main_activity_code: data.mainActivityCode ?? null,
        main_activity_description: data.mainActivityDescription ?? null,
        simples_opted: data.simplesOpted ?? null,
        mei_opted: data.meiOpted ?? null,
        tax_regime: data.taxRegime,
        tax_regime_source: data.taxRegimeSource ?? null,
  ...
  async update(
    ...
    const raw = await prismaClient(this.prisma, context).supplier.update({
      ...
      data: {
        ...
        share_capital_cents: data.shareCapitalCents,
        main_activity_code: data.mainActivityCode,
        main_activity_description: data.mainActivityDescription,
        simples_opted: data.simplesOpted,
        mei_opted: data.meiOpted,
        tax_regime: data.taxRegime,
        tax_regime_source: data.taxRegimeSource,
